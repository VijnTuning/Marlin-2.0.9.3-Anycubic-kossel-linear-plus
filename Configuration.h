...
#define STRING_CONFIG_H_AUTHOR "Jurre Vijn" // Who made the changes.
...
// Show the bitmap in Marlin/_Bootscreen.h on startup.x
...
#define CUSTOM_MACHINE_NAME "Kossel Jurre"
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -15.5 }
